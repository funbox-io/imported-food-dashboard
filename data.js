...
// 국가명 → 국기 (ORIGINS 외 국가 대응 — 실데이터 모드에서 임의 국가 유입 대비)
const FLAG_EXTRA = {
  "인도":"🇮🇳","인도네시아":"🇮🇩","말레이시아":"🇲🇾","필리핀":"🇵🇭","캐나다":"🇨🇦","멕시코":"🇲🇽",
  "칠레":"🇨🇱","페루":"🇵🇪","스페인":"🇪🇸","영국":"🇬🇧","네덜란드":"🇳🇱","벨기에":"🇧🇪","폴란드":"🇵🇱",
  "튀르키예":"🇹🇷","터키":"🇹🇷","러시아":"🇷🇺","뉴질랜드":"🇳🇿","아르헨티나":"🇦🇷","에콰도르":"🇪🇨",
  "노르웨이":"🇳🇴","덴마크":"🇩🇰","스위스":"🇨🇭","오스트리아":"🇦🇹","대만":"🇹🇼","홍콩":"🇭🇰",
  "싱가포르":"🇸🇬","캄보디아":"🇰🇭","라오스":"🇱🇦","미얀마":"🇲🇲","스리랑카":"🇱🇰","파키스탄":"🇵🇰",
};
const ORIGIN_META = Object.fromEntries(ORIGINS.map(o=>[o.c,o]));
const flagOf = c => (ORIGIN_META[c]||{}).f || FLAG_EXTRA[c] || "🏳️";
const metaOf = c => ORIGIN_META[c] || {c, f:flagOf(c), annual:"—", items:[]};
